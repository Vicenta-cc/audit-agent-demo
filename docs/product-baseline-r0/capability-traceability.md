...
| MediaCrawler acquisition | External MediaCrawler HEAD `ec56ebf...` and adapter | Compatibility dependency, not copied | Adapter boundary inspection | Dirty external changes are not yet reproducible; see dependency manifest |
...
| Hermes M2.2 Account drilldown | `account_corpus`, Account activity modules, R3.1 Account projection | Canonical future Agent route | Account fixture hash and offline service tests | No new Account A0/A1/A2 runtime integration |
