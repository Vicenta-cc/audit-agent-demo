...
export const mockPolicies: ResearchPolicy[] = [
  {
    ...
    recognitionCapabilities: ["文本语义", "OCR", "视觉识别", "ASR", "逐条评论审核"],
    references: [
  ...
  },
  {
    ...
    recognitionCapabilities: ["文本语义", "OCR", "视觉识别", "逐条评论审核"],
    references: [
  ...
  },
  {
    ...
    lexiconNames: ["软色情词库"],
    contentScopes: ["标题正文", "评论弹幕", "图片视频", "语音内容"],
    recognitionCapabilities: ["文本语义", "ASR", "视觉识别", "逐条评论审核"],
    references: [
  ...
  },
  {
    ...
    lexiconNames: ["民族意识形态风险知识包", "民族意识形态风险词库"],
    contentScopes: ["标题正文", "评论弹幕", "账号资料"],
    recognitionCapabilities: ["文本语义", "逐条评论审核", "OCR"],
    references: [],
  ...
  },
  {
    ...
    recognitionCapabilities: ["ASR", "文本语义", "逐条评论审核"],
    references: [],
